...
import co.edu.uniquindio.proyectois2backend.services.implementacion.ServicioServiceImple;
...
public class ServicioController {
    ...
    private final ServicioServiceImple servicioServiceimple;
    ...
    public ResponseEntity<List<InformacionServicioDTO>> obtenerTodosLosServicios() {
        List<InformacionServicioDTO> servicios = servicioServiceimple.obtenerTodosLosServicios();
